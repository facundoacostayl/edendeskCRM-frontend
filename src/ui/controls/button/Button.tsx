...
export const Button: React.FC<Props> = ({
  ...
  return (
    ...
    onClick={onClose || onOpenModal || onConfirmModalSubmit}
      className={`"w-full py-1 lg:py-1 px-2 lg:px-2 text-lg lg:text-xl font-bold rounded-md duration-200 cursor-pointer ${
        colorScheme === "primary"
      ...
      ${colorScheme === "borders" && "text-white border-4 border-white hover:bg-indigo-500"}`}
    >
      {children}
    </button>
  );
